...
public class FlushPlatformCert {
    ...
    public Map<String, X509Certificate> flushCert(){
        ...
        final AcquirePlatformCert.ResultDataFromCertApi resultData = platformCertList.getCertList(WeChatPayAuthHandle.buildAuthorization(signatureInfoModel,certInfo.getApiPrivateKey()));
